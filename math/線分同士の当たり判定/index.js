...
var emitter = new Emitter(150, 50, Particle);
emitter.rate = 5;
...
function hit(p, p0, p1, p2) {
	...
	var t = segToSeg(p0, p1, p2, v, { x: p.px, y: p.py });
...
let bar = [];
bar.push({ start: { x: 50, y: 75 }, end: {x: 150, y: 175} });
bar.push({ start: { x: 250, y: 275 }, end: {x: 350, y: 175} });
bar.push({ start: { x: 50, y: 275 }, end: {x: 150, y: 375} });
